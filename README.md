...
本项目是 **善筹网**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-202-shan-chou-wang-zhong-chou-qian-hou-tai-xian`

**原始压缩包名**：`springboot202善筹网（众筹）前后台实现设计`
